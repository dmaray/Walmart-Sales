...
* [R Code](p.RMD): Contains the code for the project.
...
* [Presentation](<Walmart Project Slides.pdf>): Contains the presentation based on our code & report that was presented to the class.
